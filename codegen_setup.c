...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Armored Core: Master of Arena",
    .project_root_env = "ARMORED_CORE_MASTER_OF_ARENA_PROJECT_ROOT",
    .build_dir_env = "ARMORED_CORE_MASTER_OF_ARENA_BUILD_DIR",
    .force_setup_env = "ARMORED_CORE_MASTER_OF_ARENA_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.30_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Armored_Core_Master_of_Arena",
    .prepare_note =
