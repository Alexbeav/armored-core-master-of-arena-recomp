...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/armored-core-master-of-arena-recomp/total)](https://github.com/Alexbeav/armored-core-master-of-arena-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/armored-core-master-of-arena-recomp/latest/total)](https://github.com/Alexbeav/armored-core-master-of-arena-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/armored-core-master-of-arena-recomp)](https://github.com/Alexbeav/armored-core-master-of-arena-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Armored Core: Master of Arena** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLUS-01030, SLUS-01081 2 disc images
...
|---|---|
| Region | USA |
| Disc serials | SLUS-01030, SLUS-01081 |
| Discs | 2 |
| Supported dump | Redump `Armored Core - Master of Arena (USA) (Disc 1).cue`, `Armored Core - Master of Arena (USA) (Disc 2).cue` as CUE/BIN or CHD |
| BIOS | SCPH-1001 (USA), 524288 bytes, SHA-256 `71af94d1e47a68c11e8fdb9f8368040601514a42a5a399cda48c7d3bff1e99d3` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/armored-core-master-of-arena-recomp/releases)
   and extract it into a writable folder.
2. Start `Armored_Core_Master_of_Arena` (`.exe` on Windows).
3. In the setup wizard select your 2 disc images (the Redump CUE, or a CHD of the
...
- A seam artifact reported during play testing is under separate investigation and is not addressed in this release. PGXP stays off by default.
...
named `diagnostic-mode.txt` next to `Armored_Core_Master_of_Arena.exe` and start the game as
usual, or run `Armored_Core_Master_of_Arena.exe --diagnostic`. Reproduce the problem, quit, then
run `Armored_Core_Master_of_Arena.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
